...
int main()
{
  ...
  string tekst(wpisaneslowo);
  
  int liczba_znakow = tekst.length();
  
  cout<<"Podany ciąg składa się z "<<liczba_znakow<<" znaków."<<endl;
  cin.get();

  while(liczba_znakow<5)
  {
    cout<<"Poziom trudności: ŁATWY"<<endl;
    break;
  }
  while(liczba_znakow>5 && liczba_znakow<10)
  {
    cout<<"Poziom trudności: ŚREDNI"<<endl;
    break;
  }
  while(liczba_znakow>10)
  {
    cout<<"Poziom trudności: TRUDNY"<<endl;
    break;
  }
